...
function validId(val) {
    if (val ==1){
        ...
        document.getElementById('id_card_no').setAttribute('placeholder',"TT577758");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter 8 Digit State Id No");
    }else if(val ==2){
        document.getElementById('id_card_no').setAttribute('type','text');
        document.getElementById('id_card_no').setAttribute('data-minlength','9');
        document.getElementById('id_card_no').setAttribute('placeholder',"123456789");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter 9 Character Social Security No");
    }else if(val ==3){
        document.getElementById('id_card_no').setAttribute('type','text');
        ...
        document.getElementById('id_card_no').setAttribute('data-error',"Enter 7 or more Character Valid Passport No");
    }else if(val == 4){
        document.getElementById('id_card_no').setAttribute('type','text');
        ...
        document.getElementById('id_card_no').setAttribute('data-error',"Enter 16 Character Valid Licence Number");
    }
}
